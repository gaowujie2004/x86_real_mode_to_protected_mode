...
SECTION MBR_CODE
    ...
    mov word [cs:gpt_limit+0x7c00], 31; 界限值=表总字节数-1，也等于最后一字节偏移量（一共两个描述符，一个描述符占8字节）
...
flush:   
    ...
    mov ebx, 0x7c00
    mov ax, 0b00000000_00011_000
    mov ds, ax
    mov es, ax

    mov edi, data1 ;目标，es:edi
    mov esi, data2 ;源，  ds:esi
    ...
    ;测试 cmpb、cmpw、cmpd
    data1 db 0x11, 0x12, 0x13, 0x14
    data2 db 0x11, 0x12, 0x14, 0x14
