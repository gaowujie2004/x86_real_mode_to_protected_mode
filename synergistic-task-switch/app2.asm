...
SECTION data vstart=0
      msg_start         db 0x0d,0x0a, 0x20,0x20,0x20,0x20, '[App-2]: Enter User Program 222',0
      msg_switch        db 0x0d,0x0a, 0x20,0x20,0x20,0x20, '[App-2]: now task switch.......',0
      msg_exit          db 0x0d,0x0a, 0x20,0x20,0x20,0x20, '[App-2]: again enter user program. but now exit !!!!!!',0
